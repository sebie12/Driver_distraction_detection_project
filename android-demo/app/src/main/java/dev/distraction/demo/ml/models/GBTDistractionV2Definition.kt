...
class GBTDistractionV2Definition : TreeModelDefinition() {
    override val id: String = "GBT_distraction_v2"
    override val displayName: String = "GBT Distraction v2"
    override val version: String = "2.0"
    
    override val windowDurationMillis: Long = 10000L
    override val threshold: Float = 0.35150405764579773f
    override val metadataAssetPath: String = "models_trees/GBT_distraction_v6/metadata.json"
    override val tfliteAssetPath: String = "models_trees/GBT_distraction_v6/model.tflite"
